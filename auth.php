...
class auth_plugin_googleoauth2 extends auth_plugin_base {
        ...
        if (!empty($authorizationcode)) {
            ...
            if (!empty($accesstoken)) {
                ...
                if (empty($user)) {
                    ...
                    $googleuserprefix = strtolower(get_config('auth/googleoauth2', 'googleuserprefix'));
    ...
    function process_config($config) {
		...
		set_config('googleuserprefix', strtolower($config->googleuserprefix), 'auth/googleoauth2');
