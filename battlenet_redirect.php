...
/*
 * Get battlenet code and call the normal login page
...
if (empty($code)) {
    throw new moodle_exception('battlenet_failure');
}
...
$url = new moodle_url($loginurl, array('code' => $code, 'authprovider' => 'battlenet'));
redirect($url);
